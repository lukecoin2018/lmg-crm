...
export default function OpportunitiesPage() {
  ...
  // Instagram + TikTok similarity detection hook (CHANGED: Now includes discoverTikTok)
  const { discover, discoverTikTok, result: instagramResult, loading: instagramLoading, error: instagramError, progress } = useDiscovery(userId || '');
  const [instagramHandle, setInstagramHandle] = useState('');
  const [tiktokHandle, setTiktokHandle] = useState(''); // NEW: TikTok handle state
  ...
  // NEW: Handle TikTok similarity search
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-2 mb-6 border-b border-zinc-800">
          {([
            ...
            { id: 'youtube', label: 'YouTube', icon: '📺', badge: 'Soon' },
